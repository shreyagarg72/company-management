...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/company-manage/resources/css/mainpage.css">
    <link rel="stylesheet" type="text/css" href="/company-manage/resources/css/media.css">
</head>
<body>
    ...
    <nav>
        <div class="container main-nav flex">
            <a href="#" class="company-logo">
                <img alt="company logo" src="/company-manage/resources/images/asset1.jpg" >
            </a>
            <div class="nav-links" id="nav-links">
                <ul class="flex">
                    ...
                    <li><a href="updateProfile"  class="hover-link">Update Profile</a></li>
                    <li><a href="showUser" class="hover-link secondary-button">Show User</a></li>
                    <li><a href="view-user-project" class="hover-link secondary-button">View Projects</a></li>
                </ul>
            </div>
    ...
    <header>
        <div class="container header-section flex">
            ...
            <div class="header-right">
                <img src="/company-manage/resources/images/asset2.jpeg" alt="hero image">
            </div>
        </div>
    </header>
    ...
    <section class="companies-section">
        <div class="container">
            ...
            <div class="logos flex">
                ...
                <img class="logo" src="/company-manage/resources/images/asset5.png" alt="">
                <img class="logo" src="/company-manage/resources/images/asset6.png" alt="">
                <img class="logo" src="/company-manage/resources/images/asset7.png" alt="">
                <img class="logo" src="/company-manage/resources/images/asset8.png" alt="">
                <img class="logo" src="/company-manage/resources/images/asset9.png" alt="">
            </div>
        </div>
    </section>
    ...
    <section class="features-section">
        <div class="container">
            ...
            <div class="features-area flex">
                ...
                <div class="features-card flex">
                    <img src="/company-manage/resources/images/asset15.png" alt="">
                    <h3>Design surveys</h3>
                    <p>Get feedback on images, videos or audio files.</p>
                    <a href="#" class="secondary-button">Learn more <i class="fa-solid fa-right-long"></i></a>
                </div>
                <div class="features-card flex">
                    <img src="/company-manage/resources/images/asset16.png" alt="">
                    <h3>Preference tests</h3>
                    <p>Find out which designs users prefer and why.</p>
                    <a href="#" class="secondary-button">Learn more <i class="fa-solid fa-right-long"></i></a>
                </div>
                <div class="features-card flex">
                    <img src="/company-manage/resources/images/asset17.jpeg" alt="">
    ...
    <section class="big-feature-section">
        <div class="container flex big-feature-container">
            <div class="feature-img">
                <img src="/company-manage/resources/images/asset18.png" alt="">
            </div>
    ...
    <section class="big-feature-section">
        <div class="container flex big-feature-container" id="second-big-feature">
            <div class="feature-img">
                <img src="/company-manage/resources/images/asset21.jpeg" alt="">
            </div>
            <div class="feature-desc flex">
                <h4>Effortless validation for</h4>
                <h3>Design professionals</h3>
    ...
    <section class="big-feature-section">
        <div class="container flex big-feature-container">
            <div class="feature-img">
                <img src="/company-manage/resources/images/asset24.jpg" alt="">
            </div>
            <div class="feature-desc flex">
                <h4>Effortless validation for</h4>
                <h3>Design professionals</h3>
    ...
    <section class="examples-section">
        <div class="container">
            ...
            <div class="examples-area flex">
                ...
                <a class="examples-card" href="#" style="background: linear-gradient(rgb(0, 0, 0, 0.1), rgb(0, 0, 0, 0.8)), url(/company-manage/resources/images/asset34.png); background-size: cover;">
    ...
    <footer>
        <div class="container flex footer-container">
            <a href="#" class="company-logo">
                <img src="/company-manage/resources/images/asset23.jpg" alt="company logo">
            </a>
